        ...
        <table class="order-details">
            <thead>
                <tr>
                    <th width="50%" colspan="2">  
                        <img  class="m-4 "src="{{ url('favicon.ico') }}" alt="" style="height: 40px; width:60px; margin-right:10px;"> 
                         <span class="text-start  " style="font-size: 40px">{{ env('APP_NAME') }}</span>               
                    </th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $uinvoice->payment_status }}</td>
                </tr>
                <tr>
                    <td>Payment ID:</td>
                    <td>{{ $uinvoice->payment_id==NULL?'-':$uinvoice->payment_id ; }}</td>
                </tr>  
            </tbody>
        </table>
        <table>
