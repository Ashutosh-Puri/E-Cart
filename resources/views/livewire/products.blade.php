            ...
            <nav class="bg-custom">
                ...
                <ul class="navbar-nav px-3">
                    @forelse ($categories as $c)
                        <li class="nav-item">
                            <input id="{{ $c->slug  }}" type="checkbox" wire:model="categoryInputs"value="{{ $c->id  }}" id=""> &nbsp; <label for="{{ $c->slug   }}">{{ $c->name  }}</label>
                        </li>
                    @empty
                        <li class="nav-item">
                ...
                <div class="col-md-3">
                    <div class="bg-custom card my-1 product-card ">
                        <div class=" card-header text-center fw-bold fs-4 p-0">
                            ...
                            @else
                                <p class="btn btn-danger btn-sm float-end">Outof Stock</p>
                            @endif
                            <br>
                        ...
                        <div class="card-body"style="height: 300px;  width:100%;">
                            ...
                            @else
                                <a href="{{ url('viewproduct/'.$p->id) }}">
                                    <img src="" alt="No Image Found" style="height: 300px;  width:100%;">
                                </a>
                            @endif
                        </div>
                        <div class="p-4">
                            <div class="  fs-2 text-center my-2 ">
                                ...
                                <a href="#" class="btn btn-custom mx-1"><i class="fa fa-heart"></i></a>
