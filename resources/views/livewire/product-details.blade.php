                                    ...
                                    <table class="table table-striped bordered table-inverse text-white  ">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan=2><span class="input-group">
                                                <button class=" btn btn-sm btn-custom "><i class="fa fa-minus"></i></button>
                                                <input class="form-control-sm fw-bold"type="text" value="{{ $p->quantity }}">
                                                <button class="btn-plus  btn btn-sm btn-custom"><i class="fa fa-plus"></i></button>
                                            </span></td>
                                        </tr>
                                        @if ($p->productColors)
                                            <tr>
                                                <td><span class="h4  ">Color:</span></td>
                                                <td colspan=2 class="">
                                                @foreach ($p->productColors as $col)
                                                    {{$col->colors->name.'('.$col->color_quantity.') , ' }}
                                                @endforeach
                                              </td>
                                            </tr>
                                        @endif
                                        ...
                                        <tr>
                                            <td colspan=3>
                                                <a class="btn  btn-custom" href="#"><i class="mx-2 fa fa-cart-plus"></i>Add to Cart</a>
                                                <a class="btn  btn-custom" href="#"><i class="mx-2 fa fa fa-heart"></i>Add to Wishlist</a>
                                                <a class="btn  btn-custom" href="#"><i class="mx-2 fa fa-shopping-bag"></i>Buy Now</a>
                                            </td>   
                                        </tr>
                                    </table>
                                    @if ($p->small_description)
                                    <p class="h4 text-white ">Description:</p>
